...
Hello React Front-end is a web application that displays a random greeting message on screen the app [Hello Rails Backend](https://github.com/Balikuddembe/hello-rails-back-end) API.
...
This [API](https://github.com/Balikuddembe/hello-rails-back-end)
...
```sh
  cd my-folder
  git clone  https://github.com/Balikuddembe/hello-react-front-end
```
...
Feel free to check the [issues page](https://github.com/Balikuddembe/hello-react-front-end/issues).
